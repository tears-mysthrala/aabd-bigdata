...
enpresak_datuak = [
    {
        ...
        "Zergatik konbinazio hau?": "Python: datu-analisia eta ibilbideen ereduak; JavaScript: web-interfaze interaktiboak. Ariketako hautu hipotetikoa da, ez Glovoren benetako stackaren baieztapena.",
...
dependentzia_analisia = {  # Adibidea da: benetako menpekotasunak bertsioaren arabera aldatzen dira.

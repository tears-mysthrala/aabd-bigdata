...
Ariketa bakoitza funtzio bat da (`ariketa_X_Y()`): irakurgarria, berrerabilgarria
eta probagarria. Gelaxka bakoitzak definizioa + deia ditu (interaktiboan ere
exekutatzen da). `main()` denak ordenan exekutatzen ditu.
"""

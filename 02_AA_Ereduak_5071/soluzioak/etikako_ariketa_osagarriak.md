...
### Benetako kasu bati aplikatzea: C-203/22, Dun & Bradstreet Austria

EBko Justizia Auzitegiaren C-203/22 auzian, telefono-operadore batek bezero bati kontratua ukatu zion bere kreditu-kaudimenari buruzko automatizatutako ebaluazioaren ondoren. Bezeroak ebaluazio horren logikari buruzko informazio esanguratsua eskatu zuen. Auzitegiaren epaia GDPR 15(1)(h) artikuluaren interpretazioari buruzkoa izan zen; beraz, ez da 22. artikuluko baldintza guztiak kasu horretan behin betiko erabaki zirela esango.

Fluxuan aplikatuta: (1) pertsona identifikagarri baten finantza-datuak prozesatu ziren; (2) puntuazioak pertsonaren kaudimena ebaluatu zuen, profilatzea egon zitekeen; (3) balorazioa automatikoki sortu zen, baina operadorearen azken erabakian giza esku-hartze esanguratsua egon ote zen kasu-faktuen arabera egiaztatu behar da; (4) kontratua ukatzeak ondorio garrantzitsua izan dezake. Horrenbestez, puntuazio automatikoak azken erabakia baldintzatzen bazuen eta giza berrikuspen erreala falta bazen, 22(1) artikuluaren azterketa behar da. Ez da automatikoki “22. artikuluaren urraketa” ondorioztatzen; salbuespen eta babes-neurriak eta erabaki-katea aztertu behar dira. Auzitegiak, gutxienez, 15(1)(h)ko informazioak prozedura eta erabilitako printzipioak ulertzeko moduan azaldu behar dituela ebatzi zuen.

Artikulu 22ren aplikazioaren inguruko konparazio ofizial erabilgarria C-634/21 *SCHUFA Holding (Scoring)* da: Auzitegiak adierazi zuen hirugarren erabakitzaileak puntuazio automatikoan modu erabakigarrian oinarritzen bada, puntuazioa sortzen duen jarduera bera 22(1)eko erabakia izan daitekeela. Bi epaiak irakurtzeak egitateen eta erabaki-katearen garrantzia erakusten du.

**Iturri juridikoak egiaztatuta: 2026-09-24.** RGPDren testu ofizialak 22. artikuluaren baldintzak eta salbuespenak ezartzen ditu [EUR-Lex, 2016/679 Erregelamendua](https://eur-lex.europa.eu/eli/reg/2016/679). EDPB/WP29 jarraibideek erabaki automatizatuaren eta profilatzearen azalpena ematen dute [EDPB, Automated decision-making and profiling (WP251 rev.01)](https://www.edpb.europa.eu/documents/guideline/automated-decision-making-and-profiling_en). AEPDren eskubide-orriak esparru bera herritarrei azaltzen die [AEPD, Derecho a no ser objeto de decisiones individuales automatizadas](https://www.aepd.es/derechos-y-deberes/conoce-tus-derechos/derecho-no-ser-objeto-de-decisiones-individuales). [C-203/22, Dun & Bradstreet Austria](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:62022CJ0203) 15(1)(h) artikuluaren inguruko kasu erreala da, kontratu mugikor baten ukapenaren ondorengo kreditu-ebaluazio automatizatuari buruzkoa; [C-634/21, SCHUFA Holding (Scoring)](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:62021CJ0634) 22. artikuluaren scoring aplikazioari buruzko epaia da. C-203/22 auzian, “logikari buruzko informazio esanguratsua” erabakiak sortzeko prozedura eta erabilitako printzipioei buruzko azalpen ulergarri gisa interpretatu zuen Auzitegiak.
...
51. diapositibako hiru erpinak **zehaztasuna (ereduaren doitasuna)**, **gardentasuna (sistemaren azalgarritasuna)** eta **pribatutasuna (pertsonen babesa)** dira. Gelako taldeak kasu berean helburu bat defendatu behar du. Adibide honek **pribatutasuna** hautatzen du eta ez du taldearen benetako hautua ordezkatzen:
